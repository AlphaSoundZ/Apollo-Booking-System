    ...
    methods: {
        websocketSetup() {
            ...
            this.websocket.onopen = () => {
                ...
                setInterval(() => {
                    var _a;
                    (_a = this.websocket) === null || _a === void 0 ? void 0 : _a.send(JSON.stringify({ type: "event", event: "ping" }));
                ...
                if (res.type == "event") {
                    ...
                    switch (res.event) {
                        ...
                        case "userInfo":
                            ...
                            this.navPage("User", this.lastUser);
                            break;
                        case "error":
                            if (res.data.redirectTarget)
                                redirectTarget = res.data.redirectTarget;
